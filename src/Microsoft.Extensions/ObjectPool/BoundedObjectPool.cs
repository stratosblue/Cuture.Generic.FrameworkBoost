...
namespace Microsoft.Extensions.ObjectPool
{
    ...
    /// 有限大小的对象池
    /// </summary>
    public static class BoundedObjectPool
    {
        #region Public 方法
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public static IBoundedObjectPool<T> Create<T>(IObjectLifecycleExecutor<T> objectLifecycleExecutor, BoundedObjectPoolOptions options) where T : class, new()
        {
