...
public delegate void CacheEntryRemovingCallback<TKey, TValue>(TKey key, TValue value) where TValue : class;
...
/// <typeparam name="TKey"></typeparam>
/// <typeparam name="TValue"></typeparam>
public readonly struct BoundedMemoryCacheEntry<TKey, TValue> where TValue : class
{
    #region Public 字段
